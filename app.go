...
func Run() {
	...
	app.Flags = []cli.Flag{
		...
		cli.StringFlag{
			Name:   "harness-self-hosted-azure-account-key",
			Usage:  "Harness self-hosted azure account key for cache",
			EnvVar: "PLUGIN_HARNESS_SELF_HOSTED_AZURE_ACCOUNT_KEY",
		},
		cli.StringFlag{
			Name:   "harness-self-hosted-azure-tenant-id",
			Usage:  "Harness self-hosted azure tenant id for cache",
			EnvVar: "PLUGIN_HARNESS_SELF_HOSTED_AZURE_TENANT_ID",
		},
		cli.StringFlag{
			Name:   "harness-self-hosted-azure-client-id",
			Usage:  "Harness self-hosted azure client id for cache",
			EnvVar: "PLUGIN_HARNESS_SELF_HOSTED_AZURE_CLIENT_ID",
		},
		cli.StringFlag{
			Name:   "harness-self-hosted-azure-client-secret",
			Usage:  "Harness self-hosted azure client secret for cache",
			EnvVar: "PLUGIN_HARNESS_SELF_HOSTED_AZURE_CLIENT_SECRET",
		},
		cli.StringFlag{
			Name:   "harness-self-hosted-azure-oidc-token",
			Usage:  "Harness self-hosted azure oidc token for cache",
			EnvVar: "PLUGIN_HARNESS_SELF_HOSTED_AZURE_OIDC_TOKEN",
		},
		cli.StringSliceFlag{
			Name:   "buildx-options",
...
func run(c *cli.Context) error {
	...
	plugin := Plugin{
		...
		Build: Build{
			...
			HarnessSelfHostedAzureAccountKey:   c.String("harness-self-hosted-azure-account-key"),
			HarnessSelfHostedAzureTenantID:     c.String("harness-self-hosted-azure-tenant-id"),
			HarnessSelfHostedAzureClientID:     c.String("harness-self-hosted-azure-client-id"),
			HarnessSelfHostedAzureClientSecret: c.String("harness-self-hosted-azure-client-secret"),
			HarnessSelfHostedAzureOidcToken:    c.String("harness-self-hosted-azure-oidc-token"),
